...
export default function AlgorithmClient({ algorithmId }: { algorithmId: string }) {
    ...
    <div className="bg-surface min-h-screen" id="algorithm-report">
      <main className="mx-auto flex w-full max-w-[1700px] flex-col px-6 pb-24 lg:px-12">
        ...
        <div className="flex flex-col lg:flex-row gap-0">
          ...
          <aside className="hidden lg:block w-52 shrink-0 border-r border-outline-variant/10 pr-10 no-export">
            <AlgorithmToc />
          </aside>

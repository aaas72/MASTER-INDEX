    ...
    <section className="flex-1 p-8 flex flex-col  bg-surface-container-lowest">
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-surface p-6 border border-outline-variant/20 flex flex-col justify-center items-center">
          ...
          <div className="bg-surface p-6 border border-outline-variant/20 flex flex-col justify-center items-center col-span-2">
            <span className="font-mono text-xs text-on-surface-variant uppercase mb-2">
              Space Complexity
            </span>
            <div className="font-mono text-secondary text-lg">
      ...
      <div className="mb-12 bg-surface border border-outline-variant/20 px-4 py-5">
      ...
      <div>
        ...
        <ul className="space-y-3 font-mono text-sm">
          <li className="flex items-center justify-between p-3 bg-surface border border-outline-variant/20">
